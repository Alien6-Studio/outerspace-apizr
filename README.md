...
Project plugin declarations and deterministic locks are described in the [development configuration guide](docs/reference/project-plugin-locks.md), separately from local installation and activation.
