...
Alternatively run `uv run uvicorn src.modules.fast_apizr.app:app`; the standalone route is `/get_fastapi_code/`. The automatically generated `/docs` describes the request schema.
