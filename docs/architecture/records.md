...
| [macOS Git and worker cleanup](macos-git-worker-cleanup.md) | First-signal EPERM reproduction, synchronized descendant preparation and retained repetition evidence |
